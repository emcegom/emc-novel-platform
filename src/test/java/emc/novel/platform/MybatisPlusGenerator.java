...
public class MybatisPlusGenerator {
    ...
    private static final String BASE_PACKAGE = "emc.novel.platform";


    private static final String DATABASE_IP = "127.0.0.1";
    private static final String DATABASE_PORT = "3308";
    private static final String DATABASE_NAME = "emc_novel_platform";
